...
public class PurchasedOrderAdapter extends BaseAdapter {
    ...
    ArrayList<PurchasedOrder> objects;

    PurchasedOrderAdapter(Context context, ArrayList<PurchasedOrder> orders) {
        ctx = context;
        objects = orders;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        PurchasedOrder p = getOrder(position);
    ...
    PurchasedOrder getOrder(int position) {
        return ((PurchasedOrder) getItem(position));
    }
